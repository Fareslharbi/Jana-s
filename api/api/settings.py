...
SECRET_KEY = 'django-insecure-g5qi(ihf%hh034r@r5)!ob#&ok_-$397_-&)m)t_harzudv=&^'
...
main_page = os.path.join(SETTINGS_PATH, "sephora-app/build") 
shop_owners_page = os.path.join(SETTINGS_PATH, 'clients/build/')
